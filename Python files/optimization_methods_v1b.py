...
Original file is located at
    https://colab.research.google.com/drive/1ggVrtqvycbgcE6hx-a0tgSJxcYpcxwdT
...
def update_parameters_with_gd(parameters, grads, learning_rate):
    ...
    for l in range(L):
        ...
        parameters["b" + str(l+1)] = parameters["b" + str(l + 1)] = parameters["b" + str(l + 1)] - learning_rate * grads["db" + str(l + 1)]
        ### END CODE HERE ###
